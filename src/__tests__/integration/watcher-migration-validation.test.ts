...
describe('Watcher Migration Validation Tests', () => {
  ...
  describe('Required Tables Existence', () => {
    it('should have context_changes table with correct schema', () => {
      ...
      const expectedColumns = [
        'sequence_id', 'session_id', 'item_id', 'key', 'operation',
        'old_value', 'new_value', 'old_metadata', 'new_metadata',
        'category', 'priority', 'channel', 'size_delta', 'created_at', 'created_by'
      ];
    ...
    it('should have context_watchers table with correct schema', () => {
      ...
      const expectedColumns = [
        'id', 'session_id', 'filter_keys', 'filter_categories', 
        'filter_channels', 'filter_priorities', 'last_sequence',
        'created_at', 'last_poll_at', 'expires_at', 'metadata'
      ];
    ...
    it('should have deleted_items table from migration 005', () => {
      ...
      const expectedColumns = [
        'id', 'session_id', 'key', 'category', 'channel', 
        'sequence_number', 'deleted_at'
      ];
  ...
  describe('Migration Completeness', () => {
    ...
    it('should handle database with partial watcher schema gracefully', () => {
      ...
      const expectedTriggers = [
        'track_context_insert', 'track_context_update', 'track_context_delete',
        'increment_sequence_insert', 'increment_sequence_update'
      ];
  ...
  describe('Performance Validation', () => {
    it('should have indexes that improve query performance', () => {
      ...
      const hasIndexUsage = explain.some(row => 
        row.detail.includes('idx_changes_session_seq') || 
